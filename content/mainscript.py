...
pygame.display.flip()
Objects=Object("labyrinthe.json","images/ether.jpg","images/plastictube.jpg","images/needle.jpg",main_window)
Objects.loading(main_window)
Mcgyver=Character("images/Mcgyver.png","labyrinthe.json")
Mcgyver.loading(main_window)
Guardian=Opponent("images/guardian.png","labyrinthe.json")
